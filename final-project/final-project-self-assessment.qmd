...
3.  For each spec, assess your work as *Not yet* or *Meets spec*. In one to two sentences, explain your assessment.
    ...
    2.  (Optional) Choose two specs that are eligible for *Exceeds spec*. Open an Issue for each one describing what you would do to exceed the spec. \[Exceeding two specs is a requirement for an A. You can accomplish that without doing this step, but this will help.\]
