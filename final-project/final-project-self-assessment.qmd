...
The final project specs are listed on the [Final Project](final-project.qmd) page. You are going to assess your own work for each spec.

1.  Create a markdown file in your project repo called `self-assessment.md`.
2.  Create one header for each category of specs and a subheader for each individual spec.
3.  For each spec, assess your work as *Not yet* or *Meets spec*. In one to two sentences, explain your assessment.
    1.  For each specs you assess as *Not yet*, open an Issue on GitHub describing what you think you would need to do to meet the spec.
