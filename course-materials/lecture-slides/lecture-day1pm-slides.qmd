...
##  {#workflow-jigsaw-1 data-menu-title="Workflow organization jigsaw"}

[Workflow organization jigsaw]{.slide-title}
...
-   Each group will look at their corresponding workflow
    1.   <https://github.com/kelpecosystems/global_kelp_time_series>
    2.   <https://github.com/bencecc/ReefFishStability/tree/v1>
    3.   <https://github.com/NCEAS/ca-mpa>
...
##  {#workflow-jigsaw-2 data-menu-title="Workflow organization jigsaw"}

[Workflow organization jigsaw]{.slide-title}

<hr>

-   Form groups with one student _from each workflow_
